...
const Contactus = () => {
    ...
    const handlesubmit = () =>{
        window.open(`mailto:testmarftly@gmail.com?subject=Sample&body=${body}`)
    }
    return (
        ...
        <div className="headerContact">
            <Image className="imageContact" src='https://media.istockphoto.com/photos/wooden-sphere-with-symbol-telephone-email-address-mobile-and-location-picture-id1221329241?k=20&m=1221329241&s=612x612&w=0&h=YinuWGyJqepDXyOMB2Skc8yq_UdnF0lahKxaYCtT-M0=' alt="contactImage" objectFit="cover"/>
            <div className="text">
                <h2>Contact</h2>  
            </div>
            ...
            <div className="showAdrss">
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3> Address</h3>
                        <p>Coza Store Center 8th floor, 69 F11 St, Islamabad, ISL 46500 PK</p>
                    </div>
                </div>
                    <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Lets Talk</h3>
                        <p className="infoCtn">+923085702327</p>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Sale Support</h3>
                        <p className="infoCtn">testmarftly@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
